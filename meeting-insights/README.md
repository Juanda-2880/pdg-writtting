...
durable, traceable record in [`meetings/`](../meetings/README.md).
...
The output lives in [`meetings/`](../meetings/README.md) — one file per meeting plus an
...
- **Boundary:** the skill writes **only** into `meetings/`. It never edits `ADR.md`,
...
`meetings/AAAA-MM-DD-<slug>.md`, add its row to `meetings/INDEX.md`, and report back which
