# Reference & Citation Writing Module

This module provides comprehensive rules, structures, and ethical standards for attributing external sources in academic research, empirical theses, dissertations, and scientific papers according to the APA 7th edition standard.

---

## Purpose

Academic integrity, analytical rigor, and disciplinary dialogue depend on accurate and ethical citation practices. This module ensures that:
1. Writers distinguish between **Direct Quotations** (exact verbatim reproductions) and **Indirect Citations** (paraphrasing and synthesis).
