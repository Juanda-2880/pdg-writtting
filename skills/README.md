...
| [`revision-humana/`](./revision-humana/README.md) | Human-only correction pass over one section: the person's chat feedback is applied, AI suggestions wait for approval by id, and everything is logged in `../thesis/REVISIONES.md`. |
