...
1. **Never write generated files outside this folder.** Source content lives in the module folders (`thesis-writing/`, `project-context/`, the future `latex/` project, etc.) and must stay free of build artifacts.
