...
- Checks every indirect citation in the reviewed section against its entry in `thesis/CITAS-VERIFICADAS.md` (`reference-writting/source-fidelity.md`). A citation with no entry, or whose sentence uses terms, figures or intensifiers the recorded passage doesn't contain, blocks approval of the section.
