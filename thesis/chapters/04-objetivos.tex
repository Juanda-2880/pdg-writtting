...
\begin{enumerate}
  ...
  \item \label{obj:telemetria} Desarrollar un módulo de observabilidad en la plataforma para la captura y visualización de métricas de \emph{hardware} y de carga de trabajo de los nodos de cómputo, orientado a la supervisión del estado de dichos nodos sin importar si ejecutan inferencia o entrenamiento.
