...
\begin{xltabular}{\textwidth}{p{0.21\textwidth} X p{0.14\textwidth} p{0.09\textwidth}}
        ...
        \addlinespace
        Evaluación empírica &
        Ejecución de pruebas de carga con usuarios concurrentes sobre los nodos de inferencia mediante el motor de \emph{benchmarking} automatizado, y aplicación del \emph{System Usability Scale} con usuarios finales &
...
\begin{xltabular}{\textwidth}{p{0.13\textwidth} X p{0.16\textwidth} p{0.21\textwidth}}
        ...
        \emph{Sprint} 10 &
        Ejecución del motor de \emph{benchmarking} automatizado bajo carga de usuarios concurrentes y aplicación del \emph{System Usability Scale} &
        26 abr -- 16 may 2027 &
