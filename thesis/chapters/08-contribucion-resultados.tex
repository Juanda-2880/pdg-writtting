...
\begin{xltabular}{\textwidth}{p{0.18\textwidth} X X}
        ...
        Panel de telemetría que muestra, por nodo, métricas de \emph{hardware} (temperatura, VRAM, consumo energético) y de carga de trabajo (latencia, \emph{tokens} por segundo, saturación de concurrencia), sin importar si el nodo ejecuta inferencia o entrenamiento, mediante visualizaciones gráficas interactivas &
        ...
        Reporte de desempeño de la plataforma bajo pruebas de carga con veinte usuarios simultáneos sobre los nodos de inferencia, y de aceptación operacional mediante el \emph{System Usability Scale} aplicado a usuarios del laboratorio &
