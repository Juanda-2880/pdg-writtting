...
\todo{Me gusta muchbo como abordan los conceptos teóricos, no obstante este documento hasta donde va no proporciona ni una sola imagen, es poco ilustrativo y es agotador leerlo aunque muestra información relevante, este marco teórico abre la posibilidad (solo es una posibilidad) de integrar imagenes, figuras, graficos o demás material de apoyo que ayude al lector aclarar conceptos y términos, usualmente el marco teórico es tedioso de leer porque se requiere de un nivel técnico alto para contextualizarse. Si deciden hacerlo, lo cual aconsejo, no lo hagan de manera indiscriminada (en cada seccion) sino que miren en que lugares aporta información. Nota: Si ponen imagenes o figuras, graficos, deben de referenciarlas y explicarlas textualmente: "En la figura X se presenta....."}
