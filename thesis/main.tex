...
% palabras clave, sin citas) y thesis-writing/SKILL.md Modo 2.
\chapter*{Resumen}
...
% NOTA: la "Lista de símbolos" se omite deliberadamente — el documento no
% introduce símbolos matemáticos, y el formato permite obviar esa sección.
...
% (no la estructura de tesis final de thesis-writing/structure.md). Añadir o
...
\include{chapters/03-hipotesis-restricciones}
